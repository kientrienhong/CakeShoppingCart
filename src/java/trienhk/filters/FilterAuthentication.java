...
public class FilterAuthentication implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
            FilterChain chain)
            throws IOException, ServletException {
        logger = Logger.getLogger(FilterAuthentication.class.getName());
                    ...
                    if (roleName != null) {
                        if (uri.contains("Admin")) {
                            if (!roleName.equals("admin")) {
                                url = bundle.getString(LOGIN_PAGE);
                            }
                        } else if (uri.contains("Member")) {
                            if (!roleName.equals("member") && !roleName.equals("failed") && !roleName.equals("googleAccount")) {
                                url = bundle.getString(LOGIN_PAGE);
                            }

                            if (uri.contains("trackOrder")) {
                                if (!roleName.equals("member") && !roleName.equals("admin") && !roleName.equals("googleAccount")) {
                                    url = bundle.getString(LOGIN_PAGE);
                                }
                            }
                        }
                    } else {
                        if (uri.contains("Admin") || uri.contains("trackOrder")) {
                            url = bundle.getString(LOGIN_PAGE);
                        }
                    }
                } else {
